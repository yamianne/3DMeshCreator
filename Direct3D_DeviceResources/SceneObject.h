...
public:
    ...
    SceneObject(std::string name, D3D_PRIMITIVE_TOPOLOGY topology) : Name(name), m_topology(topology) {}
    SceneObject(std::string name, Vector3 position) : Name(name), m_position(position) {}
    SceneObject(std::string name, Vector3 position, D3D_PRIMITIVE_TOPOLOGY topology) : Name(name), m_position(position), m_topology(topology) {}

    template<typename VertexType>
    SceneObject(ID3D11Device* device, std::string name,
