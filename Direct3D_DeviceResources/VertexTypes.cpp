...
const D3D11_INPUT_ELEMENT_DESC VertexTypes::VertexPositionNormal::Layout[2] = {
	{ "POSITION", 0, DXGI_FORMAT_R32G32B32_FLOAT, offsetof(VertexTypes::VertexPositionNormal, position), 0, D3D11_INPUT_PER_VERTEX_DATA, 0 },
	{ "NORMAL", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, offsetof(VertexTypes::VertexPositionNormal, normal), D3D11_INPUT_PER_VERTEX_DATA, 0 }
};